  ...
  <div className="projects">
    ...
    <div className="project-info">
      ...
      <div className="project-paragraph">
        ...
        <h4><a href="https://www.github.com/gregorcox/Event-Finder-Project" target="_blank" rel="noopener noreferrer">GitHub</a></h4>
        ...
        The app uses two APIs (<a href="https://www.skiddle.com/api/" target="_blank" rel="noopener noreferrer">Skiddle</a> and <a href="https://geocode.xyz/" target="_blank" rel="noopener noreferrer">GeoCode</a>) to fetch event and geographical data. Search results are presented on an interactive Leaflet map where users can click through to see more information and buy tickets. The user can also save their favourite events through the use of a MongoDB NoSQL database. JavaScript is used heavily on the front-end to create a modern looking, responsive and dynamic UI.<br/><br/>
    ...
    <div className="project-info project-info--reverse">
      ...
      <div className="project-paragraph">
        ...
        <h4><a href="https://www.github.com/gregorcox/Spending-Tracker-Project" target="_blank" rel="noopener noreferrer">GitHub</a></h4>
    ...
    <div className="project-info">
      ...
      <div className="project-paragraph">
        <h2>News Website - Java</h2>
          <h4><a href="https://github.com/gregorcox/News-Website-Project" target="_blank" rel="noopener noreferrer">GitHub</a></h4>
